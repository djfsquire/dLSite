<?php
class DethemeReduxFramework_slider extends DethemeReduxFramework{	
	...
	*/
	function enqueue(){
		wp_enqueue_script(
			...
			DethemeReduxFramework::$_url.'inc/fields/slider/field_slider.js', 
		...
		wp_enqueue_style(
			...
			DethemeReduxFramework::$_url.'inc/fields/slider/field_slider.css', 
			time(),
			true
		);		
