...
class DethemeReduxFramework_spinner extends DethemeReduxFramework {
    ...
    function enqueue() {
		...
		wp_enqueue_script(
			...
			DethemeReduxFramework::$_url.'inc/fields/spinner/field_spinner.js', 
		...
		wp_enqueue_style(
			...
			DethemeReduxFramework::$_url.'inc/fields/spinner/field_spinner.css', 
			time(),
			true
		);	    	
