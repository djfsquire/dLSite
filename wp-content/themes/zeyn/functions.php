...
function theme_register_required_plugins() {
	...
	$plugins = array(
		...
		array(
			...
			'core'					=> false,
			'source'   				=> 'http://detheme.com/repo/mnemonic/plugins/js_composer_4.8.0.zip', // The plugin source
			...
			'package_version' 		=> '4.8.0', // new plugin version
			'force_activation' 		=> false, // If true, plugin is activated upon theme activation and cannot be deactivated until theme switch
			'force_deactivation' 	=> false, // If true, plugin is deactivated upon theme switch, useful for theme-specific plugins
			'external_url' 			=> 'http://detheme.com/repo/mnemonic/plugins/js_composer_4.8.0.zip', // If set, overrides default API URL and points to an external URL
		),
		array(
			'name'     				=> 'Detheme Visual Composer Add On', // The plugin name
			'slug'     				=> 'zeyn_vc_addon', // The plugin slug (typically the folder name)
			'core'					=> true,
			'source'   				=> 'http://detheme.com/repo/mnemonic/plugins/zeyn_vc_addon_1.0.10.zip', // The plugin source
			'required' 				=> false, // If false, the plugin is only 'recommended' instead of required
			'version' 				=> '1.0.6', // E.g. 1.0.0. If set, the active plugin must be this version or higher, otherwise a notice is presented
			'package_version' 		=> '1.0.10', // new plugin version
			'force_activation' 		=> false, // If true, plugin is activated upon theme activation and cannot be deactivated until theme switch
			'force_deactivation' 	=> false, // If true, plugin is deactivated upon theme switch, useful for theme-specific plugins
			'external_url' 			=> 'http://detheme.com/repo/mnemonic/plugins/zeyn_vc_addon_1.0.10.zip', // If set, overrides default API URL and points to an external URL
		),
		array(
		...
		array(
			...
			'force_activation' 		=> false, // If true, plugin is activated upon theme activation and cannot be deactivated until theme switch
			'force_deactivation' 	=> false, // If true, plugin is deactivated upon theme switch, useful for theme-specific plugins
			'external_url' 			=> 'http://detheme.com/repo/mnemonic/plugins/revslider_4.6.9.zip', // If set, overrides default API URL and points to an external URL
		),
		array(
