...
// Don't duplicate me!
if (!class_exists('DethemeReduxFramework_group')) {
     ...
     * @since       1.0.0
     */
    class DethemeReduxFramework_group extends DethemeReduxFramework {
        ...
        public function enqueue() {
            wp_enqueue_script(
                    'redux-field-group-js', DethemeReduxFramework::$_url . 'inc/fields/group/field_group.js', array('jquery', 'jquery-ui-core', 'jquery-ui-accordion', 'wp-color-picker'), time(), true
            );

            wp_enqueue_style(
                    'redux-field-group-css', DethemeReduxFramework::$_url . 'inc/fields/group/field_group.css', time(), true
            );
        }
        ...
        public function enqueue_dependencies($field_type) {
            ...
            if (!class_exists($field_class)) {
                $class_file = apply_filters('redux-typeclass-load', DethemeReduxFramework::$_dir . 'redux-framework/ReduxCore/inc/fields/' . $field_type . '/field_' . $field_type . '.php', $field_class);
