...
// Don't duplicate me!
if( !class_exists( 'DethemeReduxFramework_date' ) ) {
     ...
     * @since       1.0.0
     */
	class DethemeReduxFramework_date extends DethemeReduxFramework {
		...
		public function enqueue() {
			wp_enqueue_script(
				'redux-field-date-js', 
				DethemeReduxFramework::$_url . 'inc/fields/date/field_date.js',
