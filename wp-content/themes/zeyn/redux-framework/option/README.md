...
* Feature: Eliminate REDUX_DIR and REDUX_URL constants and instead created static DethemeReduxFramework::$\_url and DethemeReduxFramework::$\_dir for cleaner code.
