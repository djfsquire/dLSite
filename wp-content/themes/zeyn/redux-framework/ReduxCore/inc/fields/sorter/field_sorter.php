 ...
 */
class DethemeReduxFramework_sorter extends DethemeReduxFramework {
    ...
    function enqueue() {
        ...
        wp_enqueue_style(
            ...
            DethemeReduxFramework::$_url.'inc/fields/sorter/field_sorter.css', 
            time(),
            true
        );  
        ...
        wp_enqueue_script(
        	...
        	DethemeReduxFramework::$_url . 'inc/fields/sorter/field_sorter.js', 
        	array('jquery'),
        	time(),
        	true
        );
