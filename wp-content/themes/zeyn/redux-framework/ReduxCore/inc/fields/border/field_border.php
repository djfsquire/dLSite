...
// Don't duplicate me!
if( class_exists( 'DethemeReduxFramework_border' ) ) return;

class DethemeReduxFramework_border extends DethemeReduxFramework {	
	...
	*/
	function enqueue(){
		...
		wp_enqueue_script(
			...
			DethemeReduxFramework::$_url.'inc/fields/border/field_border.js', 
		...
		wp_enqueue_style(
			...
			DethemeReduxFramework::$_url.'inc/fields/border/field_border.css', 
			time(),
			true
		);	
