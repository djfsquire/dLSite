					...
					foreach ( $message as $type => $plugin_groups ) {
						...
						foreach ( $plugin_groups as $plugin_group_single_name ) {
							...
							if ( $external_url && preg_match( '|^http(s)?://|', $external_url ) ) {
								$linked_plugin_groups[] = '<a href="' . esc_url( $external_url ) . '" title="' . sanitize_title($plugin_group_single_name) . '" target="_blank">' . $plugin_group_single_name . '</a>';
							}
							elseif ( ! $source || preg_match( '|^http://wordpress.org/extend/plugins/|', $source ) ) {
								...
								$linked_plugin_groups[] = '<a href="' . esc_url( $url ) . '" class="thickbox" title="' . sanitize_title($plugin_group_single_name) . '">' . $plugin_group_single_name . '</a>';
							}
							else {
